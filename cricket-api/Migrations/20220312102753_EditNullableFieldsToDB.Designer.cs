...
namespace cricket_api.Migrations
{
    ...
    [Migration("20220312102753_EditNullableFieldsToDB")]
    partial class EditNullableFieldsToDB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cricket_api.Models.GameLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("cricket_api.Models.GameLocation", b =>
                {
                    b.HasOne("cricket_api.Models.Game", "Game")
                        .WithOne("GameLocation")
                        .HasForeignKey("cricket_api.Models.GameLocation", "GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
